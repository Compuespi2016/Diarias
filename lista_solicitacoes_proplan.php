...
<body>
	...
	<?php
		$sql_solicitacao = mysqli_query($conexao,"SELECT * FROM SOLICITACAO WHERE VALIDACAO = 'Em Avaliacao: PROPLAN'");
			...
			<div class="d-flex justify-content-center">
				<div class="col-md-11 bg-light border rounded" style="border-color: black; border-style: dotted; padding: 10px;">
					<div class="row">
						...
						<div class="col-md-1">
							<a role="button" class="btn btn-primary" href="detalhe_solicitacao_proplan.php?id=<?php echo $aux['COD_SOLICITACAO']?>" >Verificar</a>
						</div>
					</div>
				</div>
			</div>
