...
<body>
	...
	<center>
		...
		<fieldset id="dados_solicitacao" class="border bg-light rounded">
			...
			<br>
			<a hole="button" class="btn btn-success" href="confirma_prad.php?id=<?php echo $sql_array['COD_SOLICITACAO']?>">Confirmar</a>
			&nbsp;&nbsp;&nbsp;
			<a hole="button" class="btn btn-danger" href="justificativa_prad.php?id=<?php echo $sql_array['COD_SOLICITACAO']?>">Negar</a>
			<br>
			<br>
	</center>
</body>
